...
// send binary data
TEST(at_client_ingest_whenReceivingGTPrompt_callGTCallback)
{
    on_ok_mock_fake.custom_fake = save_history;
    struct at_client_t client = {0};
...
TEST(at_client_ingest_whenIngestingMoreDataThanBufferSize_shouldNotCrash)
{
    on_ok_mock_fake.custom_fake = save_history;
    struct at_client_t client = {0};
